...
#asıl kod burada başlıyor öncesi googlenet şeysi

#img = image.load_img("") #taraması için
...
checkpoint = ModelCheckpoint('googlenet.h5',monitor='val_loss',mode='min',save_best_only=True,verbose=1)
